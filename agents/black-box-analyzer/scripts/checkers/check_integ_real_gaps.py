#!/usr/bin/env python3
"""Real integration test gap checker — hybrid (mechanical + model)."""
    ...
    if check_server_available(role) and candidates:
        ...
        for f in candidates:
            ...
            violations.append({
                ...
                "line": 0,
                "severity": "medium",
                "message": "No real integration test file found for this source file",
                "suggestion": f"Add tests/integration/real/test_{f.stem}.py (or equivalent)",
            })
