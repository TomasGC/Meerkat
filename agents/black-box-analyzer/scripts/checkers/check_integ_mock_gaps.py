#!/usr/bin/env python3
"""Integration/mock test gap checker — hybrid (mechanical + model)."""
    ...
    if check_server_available(role) and candidates:
        ...
        for f in candidates:
            ...
            violations.append({
                ...
                "line": 0,
                "severity": "medium",
                "message": "No integration/mock test file found for this source file",
                "suggestion": f"Add tests/integration/mock/test_{f.stem}.py (or equivalent)",
            })
