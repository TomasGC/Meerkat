#!/usr/bin/env python3
"""E2E test gap checker — hybrid (mechanical + model)."""
    ...
    if check_server_available(role) and candidates:
        ...
        for f in candidates:
            ...
            violations.append({
                ...
                "line": 0,
                "severity": "medium",
                "message": "No E2E test file found for this source file",
                "suggestion": f"Add tests/e2e/test_{f.stem}.py (or equivalent)",
            })
