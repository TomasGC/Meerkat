...
class TestModelResolution:
    ...
    def test_ask_ollama_uses_get_model_with_fast_role(self, tmp_path):
        ...
        import cli.agents.code_analyzer.analyze_code_patterns as mod
        ...
        with patch.object(mod, "_get_model", fake_get_model):
            with patch("cli.agents.code_analyzer.analyze_code_patterns.subprocess.run", return_value=mock_result):
